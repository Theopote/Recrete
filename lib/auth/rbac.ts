...
export const API_ACTION_GUARDS: Record<string, ProjectAction> = {
  ...
  "POST /api/projects/*/compliance": "run_ai_analysis",
  "POST /api/projects/*/experts/compliance": "run_ai_analysis",
  "PATCH /api/projects/*/site-measurements": "run_ai_analysis",
  "POST /api/projects/*/site-measurements/extract-from-drawings": "run_ai_analysis",
