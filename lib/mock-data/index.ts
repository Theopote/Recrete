...
export const mockDocuments: DocumentAsset[] = [
  ...
  },
  {
    ...
    uploadedById: "user-2",
    tags: ["structure", "inspection"],
    projectPhase: "diagnosis",
    versionGroupId: "doc-3",
    versionNumber: 1,
    isCurrentVersion: true,
  ...
  },
  {
    id: "doc-6",
    projectId: "proj-demo",
    name: "GB 50016-2014 Fire Code Excerpt.pdf",
    type: "pdf",
    fileUrl: "/samples/existing-condition-sample.pdf",
    fileSize: 1200000,
    mimeType: "application/pdf",
  ...
  },
  {
    id: "doc-7",
    projectId: "proj-demo",
    name: "Community Cultural Center Design Brief.pdf",
    type: "pdf",
    fileUrl: "/samples/existing-condition-sample.pdf",
    fileSize: 640000,
    mimeType: "application/pdf",
...
export const strategyMetrics: Record<string, import("@/types").StrategyComparisonMetrics> = {
  "strat-1": { cost: 25, schedule: 20, risk: 15, designValue: 40, constructionDifficulty: 20, preservationLevel: 90, feasibility: 88, lifecycleCost: 25 },
  "strat-2": { cost: 55, schedule: 50, risk: 45, designValue: 85, constructionDifficulty: 55, preservationLevel: 75, feasibility: 72, lifecycleCost: 55 },
  "strat-3": { cost: 90, schedule: 85, risk: 75, designValue: 95, constructionDifficulty: 90, preservationLevel: 40, feasibility: 55, lifecycleCost: 90 },
};
